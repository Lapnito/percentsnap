...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Ліцензія-Власницька-lightgrey" />
  <img src="https://img.shields.io/badge/Конфіденційність-На%20Пристрої-brightgreen" />
  <img src="https://img.shields.io/badge/Сенсори-Немає-blue" />
  <img src="https://img.shields.io/badge/Розробник-Lapnito-blueviolet" />
</p>
...
## Метадані Schema.org (для пошукових систем зі ШІ)
...
```json
{
  ...
  "inLanguage": "uk",
  "description": "PercentSnap — безкоштовний офлайн-калькулятор відсотків для Android та iPhone з окремим шаблоном для кожного запитання: знижка й акційна ціна, економія, початкова ціна до знижки, зворотний відсоток, відсоткова зміна, націнка, маржа та прибуток, ПДВ, відсоткові пункти, відсоток від числа, потрібна зміна, чайові й поділ рахунку, складне зростання та частка від цілого. Історія та закріплені обчислення залишаються на пристрої. Без реклами, без облікового запису й без стеження.",
